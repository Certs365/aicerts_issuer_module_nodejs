...
//  *     description: Endpoint to issue a certificate for a user.
//  *     requestBody:
//  *       required: true
//  *       content:
//  *         application/json:
...
//  *             message:
//  *               type: string
//  *               example: Certificate Issued successful
//  *             data:
...
//  *             message:
//  *               type: string
//  *               example: Certificate Issued with Number (or) User not approved!
//  *       500:
...
//  *             message:
//  *               type: string
//  *               example: An error occurred during the certificate issuance!
//  *
//  * definitions:
//  *   Issues:
//  *     type: object
...
//  *       organization:
//  *         type: string
//  *         example: user_organization
//  *       transactionHash:
//  *         type: string
//  *         example: transaction_hash
//  *       certificateHash:
//  *         type: string
//  *         example: certificate_hash
//  *       certificateNumber:
//  *         type: string
//  *         example: certificate_number
//  *       name:
//  *         type: string
//  *         example: user_name
//  *       course:
